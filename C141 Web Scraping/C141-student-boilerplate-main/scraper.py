...
# Webdriver
browser = webdriver.Chrome("C:/Users/deyde/OneDrive/Desktop/Python/C141 Web Scraping/chromedriver.exe")
...
# Convert to CSV
planet_df_1.csv('scraped.csv',index=True,index_label="id")
